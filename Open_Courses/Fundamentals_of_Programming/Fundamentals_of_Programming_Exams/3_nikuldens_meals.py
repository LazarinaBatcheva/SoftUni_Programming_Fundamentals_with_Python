<<<<<<< HEAD:Open_Courses/Fundamentals_of_Programming/Fundamentals_of_Programming_Exams/3_nikuldens_meals.py
command = input()
guests = {}
unliked_meals = 0
...
for guest, meals in sorted_guests:
    sorted_meals = sorted(meals)
    print(f"{guest}: {', '.join(sorted_meals)}")
>>>>>>> 30199c1e940310b17e9505a02bf78db7c6ad0e14:exercises/Fundamentals_of_Programming_Exams/3_nikuldens_meals.py
